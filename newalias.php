...
<tr>
	<td width="10">&nbsp;</td>
	<td valign="top">
	<h3>Add new alias to domain <font color=red><?php print( $_GET['domain'] ); ?></font></h3>
	...
	<table>
		...
		<tr>
			<td>&nbsp;</td>
			<td><input name="create" value="create" type="submit">&nbsp;<input name="reset" value="reset" type="reset"></td>
		</tr>
	</table>
	</form>
